...
<body>
    ...
    <div class="content">
                ...
                <div class="col-lg-12 border-md-end d-flex align-items-center justify-content-center">
                    <div class="py-3">
                        ...
                        <div class="row mt-3 p-3">
                            ...
                            <div class="col-lg-12">
                                <h6 class="">Do you normally use your DSE for continuous spells of an hour or more at a time?
                                <label class="mx-4">
                                    <input type="radio" name="work_hour" class="form-check-input" value="Yes" @if(isset($determiningAnswer)) @if ($determiningAnswer->work_hour == "Yes") checked @endif @endif>Yes
                                </label>
                                <label class="mx-4">
                                    <input type="radio" name="work_hour" class="form-check-input" value="No" @if(isset($determiningAnswer)) @if ($determiningAnswer->work_hour == "No") checked @endif @endif>No
                                </label>
                                </h6>
                            </div>
                    
                            <div class="col-lg-12">
                                <h6 class="">Do you use Medicine Administration Workstation on Wheels (WoW) throughout your shift?   
                                    <label class="mx-4">
                            ...
                            <div class="col-lg-12">
                                <h6 class="">How many hours on average daily do you spend using your DSE?  Answer: {{$data->average_using_dse}}</h6>
                            </div>
                    
                            <div class="col-lg-12">
                                <h6 class="">What Software do you use? </h6>
                                <label class="mx-4">
        ...
        <!-- Add more content to demonstrate multiple pages -->
