                                ...
                                @csrf
                                    <div class="d-flex gap-3 flex-wrap justify-content-center mt-4">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <input type="date" id="date" name="date" class="form-control" value="@if(isset($data)){{$data->date}}@else{{ date('Y-m-d')}}@endif" readonly>
                                        </div>
                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <div class="d-flex">
                                    ...
                                    <label for="no" class="me-3 fw-bold text-danger">
                                        NO <input type="radio" name="query{{$question->id}}" class="form-check-input" 
